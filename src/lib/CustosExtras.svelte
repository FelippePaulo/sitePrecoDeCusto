...
<div>
    ...
    <div class="custosExtras-list-wrapper">
        ...
        <form class="add-custosExtras-form" action="" on:submit|preventDefault={adicionaCusto}>
            <table>
                <tr>
                    <td><h4>nome</h4></td>
                    <td><h4>valor</h4></td>
                ...
                <tr>
                    ...
                    <td><Button class="add-custo-button" type="submit" disabled={!inputValorCustoExtra || !inputNomeCustoExtra}>adicionar</Button></td>
                </tr>
            </table>
        </form>
    </div>
